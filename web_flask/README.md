...
7. Write a script that starts a Flask web application:
...
8. Before using Flask to display our HBNB data, you will need to update some part of our engine:
...
13. Write a script that starts a Flask web application:
